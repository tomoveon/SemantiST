...
#define SEMANTIST_INPUT_SIZE    24
...
int LLVMFuzzerTestOneInput(const uint8_t *Data, size_t Size) {
    ...
    if (off < Size) {
        size_t n = 1;
        if (n > Size - off) n = Size - off;
        memcpy(semantist_fuzzer_instance + 3, Data + off, n);
        off += n;
    }
    if (off < Size) {
        size_t n = 2;
    ...
    if (off < Size) {
        size_t n = 2;
        if (n > Size - off) n = Size - off;
        memcpy(semantist_fuzzer_instance + 6, Data + off, n);
        off += n;
    }
    if (off < Size) {
        size_t n = 2;
    ...
    if (off < Size) {
        size_t n = 2;
        if (n > Size - off) n = Size - off;
        memcpy(semantist_fuzzer_instance + 10, Data + off, n);
        off += n;
    }
    if (off < Size) {
        size_t n = 2;
    ...
    if (off < Size) {
        size_t n = 2;
        if (n > Size - off) n = Size - off;
        memcpy(semantist_fuzzer_instance + 14, Data + off, n);
        off += n;
    }
    if (off < Size) {
        size_t n = 2;
    ...
    if (off < Size) {
        size_t n = 2;
        if (n > Size - off) n = Size - off;
        memcpy(semantist_fuzzer_instance + 18, Data + off, n);
        off += n;
    }
